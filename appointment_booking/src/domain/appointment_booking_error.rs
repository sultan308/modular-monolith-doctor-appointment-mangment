...
pub enum AppointmentBookingError {
    ...
    AppointmentAlreadyBooked(AppointmentEntity),
...
impl fmt::Display for AppointmentBookingError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            AppointmentBookingError::AppointmentAlreadyBooked(appointment) => write!(f, "AppointmentBookingError::AppointmentAlreadyBooked: appointment ({}) couldn't be booked because it's already booked",appointment.get_id()),
