...
pub trait PatientAppointmentRepositoryTrait: Send + Sync {
    ...
    // async fn create_patient_appointment(&mut self, patient: PatientEntity, bookable_slot: SlotEntity) -> PatientAppointmentRepositoryResult<PatientAppointmentEntity>;
