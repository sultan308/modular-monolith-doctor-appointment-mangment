...
impl AppointmentManagementService {
    ...
    pub async fn get_all_doctor_appointments_in_range(&self, doctor_id: ObjectId, from: Option<DateTime>, to: Option<DateTime>) -> DoctorAppointmentManagementResult<Vec<Appointment>> {
